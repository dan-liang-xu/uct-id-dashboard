...
export const LAYERS: LayerDef[] = [
  ...
  },
  {
    ...
    legend: { kind: 'line', color: '#7159a1', label: 'Main Road corridor' },
  ...
  },
  {
    ...
    ml: [
      { type: 'fill', paint: { 'fill-color': '#7159a1', 'fill-opacity': 0.3 } },
      { type: 'line', paint: { 'line-color': '#7159a1', 'line-width': 1.4, 'line-opacity': 0.85 } },
    ],
    legend: { kind: 'polygon', color: '#7159a1', label: 'Campus boundary' },
  ...
  // Buildings & Streets
  {
    ...
    ml: fillMl('#cbddf2', 0.35),
    legend: { kind: 'polygon', color: '#cbddf2', label: 'Buildings in study area' },
